...
export function VaultSessionGuard() {
  ...
  return (
    <>
      <div className="fixed inset-x-0 top-0 z-[70] mx-auto flex min-h-10 w-full max-w-md items-center justify-between border-b border-amber-200 bg-amber-50 px-3 py-2">
        ...
        <button
          ...
          className="ml-2 flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-amber-700 hover:bg-amber-100"
